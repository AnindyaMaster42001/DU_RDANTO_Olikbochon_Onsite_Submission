...
Run from the repo root or from Phase_2_gold/. Requires only the CSVs + the cache in this dir.
"""
import csv
import json
import os
...
finbcs = load_csv(os.path.join(REPO, "Approach_2/submission_final_bcs.csv"))
final = load_csv(os.path.join(REPO, "Approach_2/submission_final.csv"))
ids = list(finbcs)
